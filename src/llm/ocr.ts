...
import { GEMINI_OPENAI_ENDPOINT, getGeminiModel, extractChatText } from "./gemini";
...
export function buildOcrRequest(dataUrl: string, model: string = getGeminiModel(), lang: OutputLanguage = getOutputLanguage()) {
  return {
    model,
    messages: [
      {
