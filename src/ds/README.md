# PiecePool Design System — Notion 언어

`DESIGN-notion.md` 의 Notion 디자인 언어를 PiecePool 화면(`picecpool.fig`)에 입힌 React 컴포넌트 라이브러리.
...
- 디자인 언어: `~/Downloads/DESIGN-notion.md`
