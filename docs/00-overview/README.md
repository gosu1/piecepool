...
PiecePool 전체 비전·범위·용어·플랜·결정 보류. **모든 역할 필독**.
...
1. `vision.md` — 왜 만드는가
2. `scope-mvp.md` — 무엇까지 만드는가
3. `glossary.md` — 용어 통일
4. `pricing-model.md` — provider·tier·환경변수
5. `open-questions.md` — 아직 결정 안 된 것
