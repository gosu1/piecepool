...
| LLM provider | OpenAI 단일 | **OpenAI 단일** | 서준 결정: premium-only, OpenAI API |
...
- 2026-06-30: 3-provider hybrid + freemium 폐기 → **OpenAI 단일 tier** (premium-only). local(Gemma)/Gemini 제거.
